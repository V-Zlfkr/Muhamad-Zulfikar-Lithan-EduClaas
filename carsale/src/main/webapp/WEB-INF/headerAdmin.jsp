...
<header>
    ...
    <div class="header-btn-container">
        ...
        <button class="header-btn" id="header-btn-2" onclick="window.location.href='/list/carmanage'">Manage Car</button>
        <button class="header-btn" id="header-btn-2" onclick="window.location.href='/list/user'">Manage Users</button>
    </div>
